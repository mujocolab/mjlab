...
The retained soccer tasks and checkpoint hashes are listed in
[BASELINES.md](BASELINES.md); runnable commands are in
[FOOTBALL_COMMANDS.md](FOOTBALL_COMMANDS.md).
