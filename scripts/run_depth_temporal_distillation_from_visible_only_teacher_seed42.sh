...
teacher_run="2026-08-21_09-47-08_B1_A1R0_visible_only_coordinate_teacher_flat_seed42_from_walk16000_to50k_wandb"
teacher_checkpoint="$repo_dir/logs/rsl_rl/g1_velocity_football/$teacher_run/model_49999.pt"
run_name="DepthStudent_DirectLatent_from_VisibleOnly_Teacher_model49999_seed42_10k"

if [[ ! -f "$teacher_checkpoint" ]]; then
  echo "ERROR: visible-only coordinate Teacher is not complete: $teacher_checkpoint" >&2
  exit 1
fi
