...
run_name="DepthStudent_DirectLatent_unfrozen_mlp_longdropout10_camera_extrinsic_dr_seed42_resume9999_5k_wandb"
...
uv run train \
  Mjlab-Velocity-Football-Depth-TemporalTeacher-LongDropout10-CameraDR-Distillation-Flat-Unitree-G1 \
