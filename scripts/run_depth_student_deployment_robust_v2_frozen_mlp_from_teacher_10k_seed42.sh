...
run_name="DepthStudent_CalibratedVisualDR_frozenMLP_noDelay_noLongDrop_pixel5_from_B1Teacher49999_seed42_10k_wandb"
...
uv run train \
  Mjlab-Velocity-Football-Depth-TemporalTeacher-CalibratedVisualDR-FrozenMLP-Distillation-Flat-Unitree-G1 \
