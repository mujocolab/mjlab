...
run_name="A1R0_visibility_blend_v2_stagegates_seed42_from_walk16000_to20k_wandb"
...
.venv/bin/train Mjlab-Velocity-Football-A1R0-VisibilityBlend-V2-Flat-Unitree-G1 \
