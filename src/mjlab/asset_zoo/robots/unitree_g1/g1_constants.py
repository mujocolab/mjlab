...
G1_ACTUATOR_7520_14 = BuiltinPositionActuatorCfg(
  actuated_names_expr=(".*_hip_pitch_joint", ".*_hip_yaw_joint", "waist_yaw_joint"),
...
G1_ACTUATOR_7520_22 = BuiltinPositionActuatorCfg(
  actuated_names_expr=(".*_hip_roll_joint", ".*_knee_joint"),
...
G1_ACTUATOR_4010 = BuiltinPositionActuatorCfg(
  actuated_names_expr=(".*_wrist_pitch_joint", ".*_wrist_yaw_joint"),
...
G1_ACTUATOR_WAIST = BuiltinPositionActuatorCfg(
  actuated_names_expr=("waist_pitch_joint", "waist_roll_joint"),
...
G1_ACTUATOR_ANKLE = BuiltinPositionActuatorCfg(
  actuated_names_expr=(".*_ankle_pitch_joint", ".*_ankle_roll_joint"),
  stiffness=STIFFNESS_5020 * 2,
  damping=DAMPING_5020 * 2,
  effort_limit=ACTUATOR_5020.effort_limit * 2,
  armature=ACTUATOR_5020.reflected_inertia * 2,
